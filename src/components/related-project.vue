    ...
    <div class="container-fluid">
        <div class="max-w-[1720px] mx-auto">
            <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center">
                <div>
                    <img :src="chair" class='mx-auto w-14 sm:w-24' alt="">
                </div>
                <h3 class="leading-none mt-4 md:mt-6 text-2xl md:text-3xl text-title dark:text-white">
                    Related Projects
                </h3>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-[30px]">
                <router-link v-for="(item, index) in portfolioTwo.slice(0,3)" :key="index" to="/portfolio-details-v1" class="portfolio-card relative before:absolute before:top-0 before:left-0 before:w-full before:h-full before:opacity-100 before:duration-300 group overflow-hidden block">
